...
/*
 Now we use GenericClusterNode as BlastClusterNode's data structure behind the scene.
 */
typedef GenericClusterNode BlastClusterNode;
...
//} BlastCluster;
typedef GenerictCluster BlastCluster;
